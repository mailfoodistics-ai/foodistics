      ...
      >
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Sign in to your Foodistics account</p>
          </div>
          ...
          <div className="mt-4 text-center">
            <Link
              ...
              className="text-sm text-gray-600 hover:text-gray-600 hover:text-tea-gold transition-colors"
            >
